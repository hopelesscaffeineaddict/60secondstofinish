...
class GenericMutator(BaseMutator):
    ...
    def __init__(self, format_type, input_data, input_queue, stop_event, binary_name):
        super().__init__("plaintext", input_data, input_queue, stop_event, binary_name)
